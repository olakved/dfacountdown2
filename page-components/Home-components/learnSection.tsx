  ...
  return (
    <div className="md:hidden pb-[100px]">
      <div className="relative">
        <div
          className={`w-full sticky xlsm:top-[80px] top-[80px] xxlA:top-[80px] py-[40px] xxlA:pt-[80px] z-10 bg-white`}
        >
        ...
        >
          <div
            className={`max-content transition-transform duration-500 ${
              currentIndex === 1 ? 'translateY(-350px)' : 'translateY(0)'
            }`}
          >
            <div className="container">
                    ...
                    <div>
                      ...
                      <div className="mt-[10px] flex gap-[20px]">
                        ...
                        <div className="w-full text-[#6B6C7E]">
                          <p className="font-[Ubuntu] font-[400] text-[16px] leading-[24px] ">
                            <span>
                              7.5 million naira cash consolation prizes for
                              first runner up.
                            </span>
                          </p>
                        </div>
                      ...
                      <div className="mt-[10px] flex gap-[20px]">
                        ...
                        <div className="w-full text-[#6B6C7E]">
                          <p className="font-[Ubuntu] font-[400] text-[16px] leading-[24px] ">
                            5 million cash consolation prize for second runner
                            up.
                          </p>
                        </div>
                      </div>
                    ...
                    <div>
                      ...
                      <div className="mt-[10px] flex gap-[20px]">
                        ...
                        <div className="w-full text-[#6B6C7E]">
                          <p className="font-[Ubuntu] font-[400] text-[16px] leading-[24px] ">
                            <span>
                              12.5 million naira cash consolation prizes for
                              first runner up.
                            </span>
                          </p>
                        </div>
                      ...
                      <div className="mt-[10px] flex gap-[20px]">
                        ...
                        <div className="w-full text-[#6B6C7E]">
                          <p className="font-[Ubuntu] font-[400] text-[16px] leading-[24px] ">
                            10 million cash consolation prize for second runner
                            up.
                          </p>
                        </div>
                      </div>
